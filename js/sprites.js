...
,
ladder:`<svg ${NS}><ellipse cx="24" cy="43" rx="11" ry="2.6" fill="rgba(0,0,0,.15)"/><rect x="12.5" y="7" width="4.2" height="35" rx="2.1" fill="#a06a2e"/><rect x="31.3" y="7" width="4.2" height="35" rx="2.1" fill="#c98d4b"/><rect x="14" y="13" width="20" height="3.4" rx="1.7" fill="#e8c08a"/><rect x="14" y="22" width="20" height="3.4" rx="1.7" fill="#e8c08a"/><rect x="14" y="31" width="20" height="3.4" rx="1.7" fill="#e8c08a"/></svg>`,
ramp:`<svg ${NS}><ellipse cx="24" cy="43.5" rx="17" ry="2.8" fill="rgba(0,0,0,.16)"/><rect x="5" y="32" width="13" height="10" fill="#c98d4b"/><rect x="17" y="24" width="13" height="18" fill="#d69a58"/><rect x="29" y="16" width="13" height="26" fill="#e0a866"/><rect x="5" y="32" width="13" height="3" fill="#e8c08a"/><rect x="17" y="24" width="13" height="3" fill="#f0cf95"/><rect x="29" y="16" width="13" height="3" fill="#f6dcae"/><path d="M5 42 H42" stroke="#8a5a2b" stroke-width="2.4"/></svg>`,
pit:`<svg ${NS}><ellipse cx="24" cy="30" rx="18" ry="11" fill="#8a7a63"/><ellipse cx="24" cy="31" rx="15" ry="8.8" fill="#3a2f26"/><ellipse cx="24" cy="33.5" rx="10.5" ry="5.4" fill="#241c16"/><path d="M9 27 Q13 21 20 19.5" stroke="#a89473" stroke-width="2.6" fill="none" stroke-linecap="round"/></svg>`,
cornerwall:`<svg ${NS}><ellipse cx="24" cy="43" rx="16" ry="2.8" fill="rgba(0,0,0,.16)"/><rect x="7" y="26" width="16" height="16" rx="1.5" fill="#c96f45"/><rect x="23" y="12" width="17" height="30" rx="1.5" fill="#d98055"/><path d="M7 31.3 H23 M7 36.6 H23 M23 17.5 H40 M23 23 H40 M23 28.5 H40 M23 34 H40" stroke="#a4562f" stroke-width="1.7"/><path d="M15 26 V31.3 M11 31.3 V36.6 M19 31.3 V36.6 M31 12 V17.5 M27 17.5 V23 M35 17.5 V23 M31 23 V28.5 M27 28.5 V34 M35 28.5 V34" stroke="#a4562f" stroke-width="1.7"/></svg>`,
peak:`<svg ${NS}><ellipse cx="24" cy="43" rx="18" ry="2.8" fill="rgba(0,0,0,.16)"/><path d="M2 42 L17 12 L27 32 L32.5 22 L46 42 Z" fill="#8f8f9c"/><path d="M2 42 L17 12 L20 18 L8 42 Z" fill="#a4a4b0"/><path d="M17 12 L23 24 H11 Z" fill="#f2f6ff"/><path d="M32.5 22 L36 27.5 H29 Z" fill="#f2f6ff"/></svg>`,
numblocks:`<svg ${NS}><ellipse cx="24" cy="42" rx="17" ry="2.8" fill="rgba(0,0,0,.16)"/><g font-family="Fredoka,Arial,sans-serif" font-weight="900" font-size="11" text-anchor="middle"><rect x="4" y="26" width="14" height="14" rx="3" fill="#ff5d73"/><text x="11" y="36.5" fill="#fff">1</text><rect x="17" y="26" width="14" height="14" rx="3" fill="#5ab8ff"/><text x="24" y="36.5" fill="#fff">2</text><rect x="30" y="26" width="14" height="14" rx="3" fill="#54d66a"/><text x="37" y="36.5" fill="#fff">3</text><rect x="17" y="12" width="14" height="14" rx="3" fill="#ffd66b"/><text x="24" y="22.5" fill="#8a5a2b">4</text></g></svg>`
};
