...
const BRAIN=[
  {k:["move","moving","stuck","walk"],a:"In the world you don't count steps — you name a destination. Add 🚶 Walk To and pick what to walk to (🌳 tree, 🪨 rock, 🏪 market…). Your robot finds its own way around whatever is in between, and arrives FACING it, so a ✋ Collect or 🪓 Chop right after just works.\n\nIf it's not moving, check:\n1️⃣ Did you press ▶ Run?\n2️⃣ Is there any of that thing left on the map?\n3️⃣ Does the program have blocks in it?"},
