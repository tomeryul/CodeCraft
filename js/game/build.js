...
const DECOR=[
  ...
  {id:"well",    em:"🪣", name:"Well",      cat:"structure", cost:{stone:2}},
  {id:"stall",   em:"🏪", name:"Market Stall",cat:"structure", cost:{wood:2}},
  /* ground */
  ...
  {id:"planter", em:"🪴", name:"Planter",  cat:"nature",    cost:{stone:1}},
  /* decoration */
  ...
  {id:"bench",   em:"🪑", name:"Bench",    cat:"decor",     cost:{wood:1}},
  {id:"table",   em:"🍽️", name:"Table",    cat:"decor",     cost:{wood:1}},
  {id:"barrel",  em:"🛢️", name:"Barrel",   cat:"decor",     cost:{wood:1}},
  {id:"crate",   em:"📦", name:"Crate",    cat:"decor",     cost:{wood:1}},
  {id:"mailbox", em:"📮", name:"Mailbox",  cat:"decor",     cost:{iron:1}},
  {id:"statue",  em:"🗿", name:"Statue",   cat:"decor",     cost:{stone:2}},
  {id:"flag",    em:"🚩", name:"Flag",     cat:"decor",     cost:{wood:1}},
  {id:"campfire",em:"🔥", name:"Campfire", cat:"decor",     cost:{wood:1}},
];
